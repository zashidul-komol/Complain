...
<div class="row animated fadeInRight">
    <div class="col-sm-12">
       <h4 class="section-subtitle"><b>Product Lists</b></h4>
        <span class="pull-right">
            {!! Html::decode(link_to_route('products.download','<i class="fa fa-download" aria-hidden="true"></i>',[],array('class'=>'btn btn-success btn-right-side'))) !!}

            {!! Html::decode(link_to_route('products.create','<i class="fa fa-plus"></i>',[],array('class'=>'btn btn-success btn-right-side'))) !!}
        </span>
        <div class="panel">
...
<div class="modal fade" tabindex="-1" role="dialog" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      {{ Form::open(array('route' => array('products.destroy', 'remove-id'),'method'=>'DELETE','id'=>'del-form')) }}
      <div class="modal-body">
        {{Form::select('product_id',[],null,array('class' => 'form-control', 'id'=>'selectBox'))}}
      </div>
