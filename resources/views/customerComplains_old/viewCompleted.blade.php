...
<div class="row animated fadeInRight">
    ...
    <span class="pull-right">
            {!! Html::decode(link_to_route('customerComplains.completed','<i class="fa fa-list"></i>',[],array('class'=>'btn btn-success btn-right-side'))) !!}
    </span>
</div>
<div class="row animated fadeInRight">
    ...
    <div class="col-sm-10">
            <div class="panel">
                <div class="panel-content">
                    ...
                    <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                        <label for="inputName" class="col-sm-4 ">Report forward to Brand department for further communication</label>
                        <div class="col-sm-7">
                            {{Form::textarea('new',$new,array('class' => 'form-control max-length','rows' => 2, 'cols' => 2,'maxlength'=>'350', 'readonly' => 'true'))}}
                        </div>
                    </div>
