...
<div class="modal fade" tabindex="-1" role="dialog" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      {{ Form::open(array('route' => array('departments.destroy', 'remove-id'),'method'=>'DELETE','id'=>'del-form')) }}
      <div class="modal-body">
        {{Form::select('department_id',[],null,array('class' => 'form-control', 'id'=>'selectBox'))}}
      </div>
